...
Check out the documentation for the [progress bar](/components/progress).
...
See [progress accessibility](/components/progress#accessibility) section for more.
...
::: code-group
<<< @/../src/themes/theme-one/components/spinner.css [spinner.css]
:::
