...
<template #example>
<div class="switch small" aria-label="Toggle theme">
	<svg
...
<div class="switch" aria-label="Toggle theme">
    ...
    <svg
    	...
    	></path></svg
    >
    <input checked id="switch-unchecked" type="checkbox" role="switch" />
</div>
</template>
...
```html
<div class="switch" aria-label="Toggle theme">
  <svg class="icon-unchecked">...</svg>
  <svg class="icon-checked">...</svg>
  <input id="switch-unchecked" type="checkbox" role="switch" />
</div>
```
...
::: code-group
<<< @/../src/themes/theme-one/components/switch.css [switch.css]
<<< @/../src/themes/theme-one/components/field-group.css [field-group.css]
:::
