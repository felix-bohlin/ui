...
<Switch small aria-label="Toggle theme">
  <template #icon-unchecked><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path
      fill="currentColor"
    ...
    ></path></svg></template>
  <template #icon-checked><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path
      fill="currentColor"
